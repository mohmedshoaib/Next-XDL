  ...
  return (
    <div className='bg-[#f8f8f8] text-black flex ed:flex-col'>
        ...
        <div className='max-w-[800px] my-[20px] ml-[55px] mr-[50px] px-4 w-full h-[91vh] text-center flex flex-col'>
            <h1 className='md:text-3xl sm:text-2xl text-xl text-bold text-left px-4 text-black md:py-6'>Data-Driven Freight Management for Streamlined Operations</h1>
            ...
            <h3 className='md:text-lg text-bold text-left px-4 text-black pb-2'>1. AP module: Audited invoice review, ensuring accuracy.</h3>   
            <h3 className='md:text-lg text-bold text-left px-4 text-black pb-2'>2. Seamless ERP integration for efficient final payments.</h3> 
            <h3 className='md:text-lg text-bold text-left px-4 text-black pb-2'>3. Flexible data transfer options: EDI, CSV, ERP formats.</h3> 
            <h3 className='md:text-lg text-bold text-left px-4 text-black pb-2'>4. On-time payments foster improved carrier relationships.</h3>
            <h3 className='md:text-lg text-bold text-left px-4 text-black pb-2'>5. Complete audit trail for streamlined financial audits.</h3>  
        </div>
